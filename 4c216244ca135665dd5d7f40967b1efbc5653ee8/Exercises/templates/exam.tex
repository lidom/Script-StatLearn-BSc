...
\usepackage{soul}% \st{Hellow world} strike out text
...
%% headings
\markright{\textnormal{\bf \large Exam ID: \myID}}
%\markboth{}%
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{University Bonn}}

\textbf{\large{Econometrics \st{Exam on } \myDate \hfill Exam ID \myID}}
...
\textbf{Name:}\\[.1cm]
\hrule \\[1.5cm]
\textbf{Student ID (matriculation number):} \\[.1cm]
\hrule \\[1.5cm]

\paragraph*{Statement of authorship:}\\[2ex]
I hereby confirm that the work presented has been performed solely by myself. 
Moreover, I confirm that the \textbf{Exam ID \myID} of this individualized exam \textbf{equals} my personal \textbf{Student ID}  (matriculation number).\\[5ex]

\textbf{Signature:} \\[.1cm]
\hrule  \\[1.5cm]
\paragraph*{Instructions:}\\[2ex]
\end{tabular}
